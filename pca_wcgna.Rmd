...
write.csv(limma_rlogc, "~/git/mtb_modules/limma_rlogc.csv", quote=F)
...
#limma_rlogc<-read.csv("~/git/mtb_modules/limma_rlogc.csv")
...
# this saves info as R object, but will this be too big?
...
>A gene significance measure could be defined without reference to a sample trait. For example, it could indicate pathway membership (1 or 0) or essentiality (1 or 0). Could we define non-coding?
