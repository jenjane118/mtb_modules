...
![heatmap trait/module correlations with p-values net2](~/git/mtb_modules/labeled_heatmap_net2.png)
...
#just get list of genes from 'lightcyan1'
...
lightcyan1_gene_df[,2] <- malone_csv[match(lightcyan1_gene_df[,1],malone_csv[,2]),4]
lightcyan1_gene_df[,3] <- malone_csv[match(lightcyan1_gene_df[,1],malone_csv[,2]),6]
colnames(lightcyan1_gene_df) <- c("ID", "gene_name", "funct_annotation")
