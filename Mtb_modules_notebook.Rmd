...
[supplementary data](btz643_supplementary_data.docx)
...
But perhaps I want to generate a coverage density plot that differentiates between coverage on each strand? In that case I might use bedtools 'coverage' instead of 'genomecov'? (or is there an option to do this on genomecov as well?)
